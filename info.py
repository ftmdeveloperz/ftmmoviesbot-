...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002247818920'))
URL = environ.get('URL', 'https://ftmmoviesbot987.onrender.com')
...
YEARS = [f'{i}' for i in range(2024 , 1982,-1 )]
...
MAX_BTN = int(environ.get('MAX_BTN', '10'))                                                                                                               AUTO_DELETE = is_enabled('AUTO_DELETE', True)
